...
namespace Proxies\__CG__\FctBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Empresas extends \FctBundle\Entity\Empresas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FctBundle\\Entity\\Empresas' . "\0" . 'id', '' . "\0" . 'FctBundle\\Entity\\Empresas' . "\0" . 'nombre', '' . "\0" . 'FctBundle\\Entity\\Empresas' . "\0" . 'direccion', '' . "\0" . 'FctBundle\\Entity\\Empresas' . "\0" . 'cp', '' . "\0" . 'FctBundle\\Entity\\Empresas' . "\0" . 'telefono1', '' . "\0" . 'FctBundle\\Entity\\Empresas' . "\0" . 'telefono2', '' . "\0" . 'FctBundle\\Entity\\Empresas' . "\0" . 'fechaCreacion', '' . "\0" . 'FctBundle\\Entity\\Empresas' . "\0" . 'alumnos'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Empresas $proxy) {
